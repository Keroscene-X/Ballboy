...
public class ControllableDynamicEntity<T extends DynamicEntity> extends DynamicEntity {
    ...
    @Override
    public ControllableDynamicEntity copy(Level level) {
        return new ControllableDynamicEntity<>((DynamicEntity) entity.copy(level), startingPosition, maxHorizontalVelocity, floorHeight, gravity);
    }
